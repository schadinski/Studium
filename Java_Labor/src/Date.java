...
//		}
//		
//		int lastCipherOfYear = this.year%10;
//		int thirdCipherOfYear = (this.year-lastCipherOfYear)%100;
//		int cipherOfYear = (thirdCipherOfYear)+lastCipherOfYear;
//		
//		int digitOfYear = 0;
//		if(this.month == 1 ||this.month ==2){
//			digitOfYear = cipherOfYear -1;
//			if(cipherOfYear == 0){
//				digitOfYear = 99;
//			}
//		}
//		
//
//		int cipherOfCentury = (this.year - cipherOfYear)/100;
//		
//		int digitOfCentury = 0;
//		if(this.month == 1 ||this.month ==2){
//			digitOfCentury = cipherOfCentury-1;
//		}

//		double temp1 =Math.floor(2.6 * digitOfMonth - 0.2);
//		double temp2 =  Math.floor(digitOfYear/4);
//		double temp3 = Math.floor(digitOfCentury/4);
//	
//		double cipherForDay = (digitOfDay+temp1+digitOfYear + temp2+ temp3-(2*digitOfCentury))%7;
//		int cipherOfDay = (int)cipherForDay;
