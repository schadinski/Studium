...
int main()
{
  ...
  while(1)
  {
    //die maximale Länge ergibt sich aus der Größe des short int, der zum speichern der Länge verwendet wird
    printf("Anzahl und Länge der Nachricht eingeben. Max. Länge ist 32767\n");
    ...
    *ptr = lenOfMessages;
    ...
    {      
      ...
      //TODO nach 7f springt es auf ffffff80
      //nach ffffffff springt es wieder auf 0 und läuft korrekt weiter
      //das ist doch bestimmt wieder so eine Überlauf-Geschichte
      // die letzten beiden Ziffern sind korrekt, aber woher kommt ffffff?
      //char max ist 127 = 0x7f
      // gleiches bei teilaufgabe 1
